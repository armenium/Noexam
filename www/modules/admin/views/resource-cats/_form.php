...
<div class="resources-grid-form">
	...
	<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data', 'id' => 'resource_cat_form']]);?>
	<div class="float-btn-group">
		<?=Html::buttonInput('Save & Preview', ['class' => 'btn btn-danger', 'data-trigger' => 'js_action_click', 'data-action' => 'preview_page', 'data-parent' => '#resource_cat_form']);?>
