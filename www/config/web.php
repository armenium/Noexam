    ...
    'components' => [
        ...
        'log' => [
            ...
            'targets' => [
                ...
                [
                    ...
                    'logVars' => ['_GET', '_POST'],
                    'categories' => ['noexam'],
                    'logFile' => '@app/runtime/logs/noexam.log',
                    'maxFileSize' => 1024 * 2,
                    'maxLogFiles' => 50,
                ],
                [
        ...
        'urlManager' => [
            ...
            'rules' => [
	            ...
	            'my-application/gobackstep' => 'my-application/gobackstep',
	            ...
	            'online-application-step-intermediary-questions' => 'my-application/online-application-step-intermediary-questions',
	            ...
	            'online-application-step-not-eligible' => 'my-application/online-application-step-not-eligible',
	            ...
	            'privacy' => 'pages/view',
	            'careers' => 'pages/view',
	            'careers/getting-started-life-insurance' => 'pages/view',
	            'help' => 'pages/view',
	            'get-my-price' => 'pages/view',
	            'calculator' => 'pages/view',
	            'partnership' => 'pages/view',
	            'apply-now' => 'pages/view',
