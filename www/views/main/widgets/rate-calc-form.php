			...
			<div class="form-wrap">
				...
				<div class="row first">
					<div class="col-xs-6">
						...
						<?=$form->field($customer_data, 'age')->textInput(['required' => 'required', 'class' => 'age form-control bark-border', 'id' => 'rc_age', 'placeholder' => 'e.g. 42', 'value' => 50])->label(false);?>
						</div>
					</div>
				...
				<?php if($guessing && $user_guess_price == 0 && $display_guess_price_field == 1):?>
				<div id="guess_price_row" class="row fifth">
					<div class="col-md-12 text-center">
						<label>Guess Price (Optional)</label>
						<div class="sub-lbl">Be a part of our pricing study by taking a guess at the monthly price</div>
						<div class="guess-price-wrap" data-prefix="$">
							<?=$form->field($customer_data, 'guess_price')->textInput(['class' => 'guess_price form-control bark-border', 'id' => 'guess_price', 'placeholder' => '', 'value' => '', 'maxlength' => "4"])->label(false);?>
						</div>
						<div class="guess-price-error-wrap">
							<div class="guess-price-error">Please guess a value between $1 and $1000.</div>
						</div>
					</div>
				</div>
				<?php endif;?>
