...
<div class="page-content page-wrapper">
	<section class="container first w882">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="title text-center">Privacy</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to No Exam Life Insurance, Inc, 22 Sloane St Suite B Roswell GA 30075.</p>
            </li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
    <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
    <li><strong>Website</strong> refers to NoExam.com, accessible from https://www.noexam.com</li>        <li><strong>Service</strong> refers to the Website.</li>
...
<ul>
        <li>By email: support@noexam.com</li>
        </ul>
			</div>
		</div>
	</section>
