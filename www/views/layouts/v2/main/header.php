...
<header id="js_header" class="header trans_me">
	<div class="header__col">
		<img src="/v2/common/images/header/Logo.svg" alt="" title="" class="header__logo" width="112" height="16">
	...
	<div class="header__col">
		...
		<a href="#" class="header__link header__link--start">Start my Quote</a>
