<ul class="nav nav-tabs custom-age-tabs justify-content-center trans_all" id="<?=$id;?>-male-AgeTab" role="tablist">
	...
	<li class="nav-item text-center" role="presentation">
		<a class="nav-link main-title" id="<?=$id;?>-male-ages-50-59-tab" data-toggle="tab" href="#<?=$id;?>-male-ages-50-59" role="tab" aria-controls="ages-50-59" aria-selected="false"><span>Ages 50-60</span></a>
	</li>
<!-- 	<li class="nav-item text-center" role="presentation">
		<a class="nav-link main-title" id="<?=$id;?>-male-ages-60-69-tab" data-toggle="tab" href="#<?=$id;?>-male-ages-60-69" role="tab" aria-controls="ages-60-69" aria-selected="false"><span>Ages 60-69</span></a>
	</li>
	<li class="nav-item text-center" role="presentation">
