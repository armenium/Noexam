<div class="wrapp">
	<section class="rates-chart-by-age">
		<h2 class="rates-chart-by-age__title heading-2">30 Year Term Life Insurance<br> Rate Chart By Age</h2>
		<p class="rates-chart-by-age__subtitle fontBodyL ">
			A 30-year term policy will offer a level premium for 30 years.
			Once the initial 30 years are up, the premium will rise annually if the policy is renewable.
		</p>
		...
		<p class="rate-chart-by-age-desc fontBodyS">* Pricing samples above are rates based on a 30-year term for a healthy non-smoking male with a Preferred Plus rating.</p>
	</section>
</div>
