<ul class="nav nav-tabs custom-age-tabs justify-content-center trans_all" id="<?=$id;?>-male-AgeTab" role="tablist">
	<li class="nav-item text-center" role="presentation">
		<a class="nav-link main-title active" id="<?=$id;?>-male-ages-18-28-tab" data-toggle="tab" href="#<?=$id;?>-male-ages-18-28" role="tab" aria-controls="ages-18-28" aria-selected="true"><span>Ages 18-29</span></a>
	</li>
	<li class="nav-item text-center" role="presentation">
		<a class="nav-link main-title" id="<?=$id;?>-male-ages-29-39-tab" data-toggle="tab" href="#<?=$id;?>-male-ages-29-39" role="tab" aria-controls="ages-29-39" aria-selected="false"><span>Ages 30-39</span></a>
	</li>
	<li class="nav-item text-center" role="presentation">
