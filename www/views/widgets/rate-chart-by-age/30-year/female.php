<ul class="nav nav-tabs custom-age-tabs justify-content-center trans_all" id="<?=$id;?>-female-AgeTab" role="tablist">
	...
	<li class="nav-item text-center" role="presentation">
		<a class="nav-link main-title" id="<?=$id;?>-female-ages-40-49-tab" data-toggle="tab" href="#<?=$id;?>-female-ages-40-49" role="tab" aria-controls="ages-40-49" aria-selected="false"><span>Ages 40-50</span></a>
	</li>
	<!--<li class="nav-item text-center" role="presentation">
