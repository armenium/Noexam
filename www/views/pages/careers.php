...
<div class="page-content page-wrapper">
	<section class="container first w830">
		<div class="row">
			<div class="col-sm-12 text-center">
				<h1 class="title">Selling Life Insurance as an Agent</h1>
			</div>
				<div class="content">
					It’s no surprise that selling life insurance is such a popular profession. With over 1 million insurance agents, brokers, and service employees in the united states in 2020, it remains one of the largest industries. One of the benefits of selling life insurance are the flexible hours. You can do it on the side at first and earn a great living if you are willing to put in the work.</p>
					<h2>Who is it for?</h2>
					...
					<p>Step 1: Take the pre-license course.<br />
					Step 2: Take the state exam.<br />
					Step 3: Get a contract with an insurance company.<br />
					Step 4: Begin contacting prospects</p>
	...
	<div class="col-sm-12 text-center">
		<h2 class="title">Job Openings<span class="badge">0</span></h2>
	</div>
	<section class="container second w830">
		<div class="row">
			<div class="col-sm-12">
				<ul class="jobs-list">
					<li class="item">
						<div class="clearfix" role="button" data-toggle="collapse" href="#job_1">
