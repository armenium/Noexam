<?php if($total_plans_count > 0):?>
	...
	<div class="quotes-result__container results-table">
		...
		<div class="quotes-result__tableRow tableRow">
			<div class="tableRow__col">
				<div class="tableRow__imgWrapp">
					<img src="/v2/myquote/img/quote-result-logo-1.png" alt="logo" class="tableRow__img">
		...
		<div class="quotes-result__tableRow tableRow">
			<div class="tableRow__col">
				<div class="tableRow__imgWrapp">
					<img src="/v2/myquote/img/quote-result-logo-4.png" alt="logo" class="tableRow__img">
					<div class="tableRow__starsWrapp">
						<img src="/v2/common/images/star.png" alt="*">
						<img src="/v2/common/images/star.png" alt="*">
						<img src="/v2/common/images/star.png" alt="*">
	...
	<div class="quotes-result__container results-table">
		...
		<div class="quotes-result__tableRow tableRow">
			<div class="tableRow__col">
				<div class="tableRow__imgWrapp">
					<img src="/v2/myquote/img/quote-result-logo-3.png" alt="logo" class="tableRow__img">
					<div class="tableRow__starsWrapp">
						<img src="/v2/common/images/star.png" alt="*">
						<img src="/v2/common/images/star.png" alt="*">
						<img src="/v2/common/images/star.png" alt="*">
